...
const offerProducts = [
  ...
  },
  {
    ...
    price: 89.99,
    discount: 31,
    image: "../bilder/headponesCards.jpg",
    description:
  ...
  },
  {
    ...
    price: 149.99,
    discount: 25,
    image: "../bilder/Airpods.jpg",
    description: "Komfortable Kopfhörer mit aktiver Geräuschunterdrückung.",
    badge: "Premium",
  },
  {
    id: 107,
  ...
  },
  {
    ...
    price: 49.99,
    discount: 29,
    image: "../bilder/mauseGaming.jpeg",
    description: "Ergonomische Gaming-Maus mit anpassbarer DPI.",
    badge: "Beliebt",
  },
  {
    id: 109,
    ...
    price: 84.99,
    discount: 29,
    image: "../bilder/ssd.jpeg",
    description: "Schnelle SSD mit 1 TB Speicherplatz für kurze Ladezeiten.",
    badge: "Top-Preis",
  },
  {
    id: 110,
  ...
  },
  {
    ...
    price: 329.99,
    discount: 18,
    image: "../bilder/prozessor.jpeg",
    description: "Moderner Mehrkern-Prozessor für leistungsstarke Desktop-PCs.",
    badge: "Neu",
  },
  {
    id: 112,
...
function getCart() {
  try {
    const storedCart = localStorage.getItem("hardwareHubCart");
...
function saveCart(cart) {
  try {
    ...
    showNotification("Der Warenkorb konnte nicht gespeichert werden.");
  }
}
...
function addProductToCart(productId) {
  ...
  if (!selectedProduct) {
    showNotification("Das Produkt wurde nicht gefunden.");
  ...
  if (selectedSort === "discount-desc") {
    filteredProducts.sort(
      (firstProduct, secondProduct) =>
        secondProduct.discount - firstProduct.discount,
    );
  }
...
function renderOffers() {
  ...
  const filteredProducts = getFilteredOffers();
  ...
  filteredProducts.forEach((product) => {
    const offerCard = createOfferCard(product);
...
function showNewsletterMessage(message, type = "error") {
  ...
  newsletterMessage.style.color = type === "success" ? "#15803d" : "#dc2626";
}
...
function handleNewsletter() {
  ...
  if (!email) {
    showNewsletterMessage("Bitte gib deine E-Mail-Adresse ein.");
  ...
  if (!isValidEmail(email)) {
    showNewsletterMessage("Bitte gib eine gültige E-Mail-Adresse ein.");
...
function applySearchFromUrl() {
  ...
  const searchTerm = parameters.get("search");
  ...
  const offersSection = document.querySelector("#angebote");
